...
// MapCalendar maps one parsed TripIt calendar into a MappedTrip. Events it
// can't classify are skipped; a multi-night hotel's two check-in/check-out
// events are paired back into a single hotel plan.
func MapCalendar(cal *Calendar) *MappedTrip {
