...
func TestG1PlanQueryErrorBranches(t *testing.T) {
	...
	checks := []struct {
		...
		{"VehicleHireDetailFor", func() error { _, e := s.VehicleHireDetailFor(cc, 1); return e }},
		...
		{"UpdateVehicleHireDetail", func() error { return s.UpdateVehicleHireDetail(cc, 1, VehicleHireDetailUpdate{Category: g1ptr("x")}) }},
