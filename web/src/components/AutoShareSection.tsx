...
/** Manage the signed-in user's "always share with" defaults as a Preferences
 * tab: a list of friends who are automatically added to every new trip the
 * user creates, each at a chosen role. Mirrors the per-trip share roles
 * (viewer/editor/passenger). Changing the list only affects future trips —
 * trips already shared keep their access. */
